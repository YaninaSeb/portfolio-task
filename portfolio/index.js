...
//BURGER-MENU
const btnBurgerMenu = document.querySelector('.btn-burger_menu');
const containerBurgerMenu = document.querySelector('.container-burger_menu');
const burgerMenu = document.querySelector('.burger-menu');
btnBurgerMenu.addEventListener('click', ()=> {
  burgerMenu.classList.toggle('open-menu');
  containerBurgerMenu.classList.toggle('container-burger_menu-blackout');
